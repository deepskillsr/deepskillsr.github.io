...
output: 
  xaringan::moon_reader:
    ...
    css: 'assets/presentationGCP_MLT.css'
    lib_dir: libs
    nature:
      ratio: '4:3'
      highlightLanguage: r
...
plot (graph1)  # Don't add space before left parenthesis since it is a function call
...
# Bad
if (is.null(ylim)) {ylim <- c(0, 0.06)}  # closing curly brace goes on its own line
if (condition) {
  one or more lines
}
